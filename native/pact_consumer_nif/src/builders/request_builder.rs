...
#[rustler::nif(name = "request_builder_contents", schedule = "DirtyIo")]
pub fn contents(
    builder: NifRequestBuilder,
    content_type: String,
    definition: String,
) -> NifResult<NifRequestBuilder> {
    builder.invoke_async(async move |b| {
        ...
        b.contents(
            content_type
                .parse()
                .map_err(|_| rustler::Error::RaiseAtom("invalid_definition"))?,
            definition,
        )
        .await;
